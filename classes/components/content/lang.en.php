<?php
	...
	$C_LANG['module_description'] = 'The module is designed to control text and graphics site materials, working with partitions, adding new material.';
	...
	$LANG_EXPORT['content_error_insert_null'] = 'Macro Error (content insert): You did not specify which page you want to insert.';
